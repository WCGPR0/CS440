...
class HashTable {
        ...
        class Iterator {
            ...
            public:
                ...
                Iterator &operator++() {
                    ...
                    if (/* Need to move to next bucket */
				    m_current == nullptr) {
			    ++m_bucket;
                ...
                Iterator operator++(int) {
                   Iterator it(m_bucket, m_current);
		   operator++();
		   return it;
		  	 
                }
                ValueType &operator*() {
                    // Syntax error here, fix.
    ...
    private:
        ...
        class LinkData : public Link {
            friend class HashTable;
            LinkData(const ValueType &v) {
                // This is broken, fix.
                K k;
                k = v.first;
                m_value = std::make_pair(k, v.second);
            }
            ValueType m_value;
        };
    ...
    public:
        ...
        Iterator end() { return Iterator(m_table[sz+1]); }
